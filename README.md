...
| 보안         | Trivy, cosign, Kyverno, PSA, Istio mTLS/AuthorizationPolicy                                         | Trivy(CI 스캔) · cosign(이미지 서명) · Kyverno(verifyImages, Enforce) · PSA 사용 중 · mTLS STRICT/AuthorizationPolicy 예정 |
